				...
				<table border="0px" height="100%" style="vertical-align:top;width:70%;border: 1px;">
					<tr height="50px">
						<td colspan="2">用例编号：<br> <input type="text"
							style="width: 95%;" id="id" value=""></td>
						<td>用例描述：<br> <input type="text" id="descript" style="width: 95%;" value=""></td>
					...
					<tr height="50px">
						<td style="vertical-align: top; width: 5%">测试模块：<br> <input
							type="text" style="width: 90%;" id="test_module" value="<%=id%>">
						</td>
					...
					<tr>
						<td colspan="2" height="50px">测试项目<br> <input
							type="text" style="width: 95%;" id="test_project" value="<%=treeroot%>"></td>
